...
const TopBarHero: React.FC<TopBarHeroProps> = ({
  ...
  const uid = useId();
  const logoMaskId = `lunora-moon-${uid}`;
  ...
  const currentMascot =
    MASCOTS[mascot as keyof typeof MASCOTS] || MASCOTS.normal;
    ...
    <div className="relative w-full overflow-hidden bg-[#020406]">
      ...
      <div className="absolute top-0 left-0 w-full h-[380px] sm:h-[450px] md:h-[520px] lg:h-[600px] overflow-hidden z-0">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 20% 30%, rgba(60,120,255,0.25), transparent 45%), radial-gradient(circle at 80% 40%, rgba(120,80,255,0.18), transparent 45%), radial-gradient(circle at 50% 80%, rgba(40,140,255,0.18), transparent 50%)`,
          }}
        />
        {/* Cloud Texture Layer */}
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(circle at 30% 40%, rgba(255,255,255,0.08), transparent 40%), radial-gradient(circle at 70% 60%, rgba(255,255,255,0.06), transparent 45%), radial-gradient(circle at 50% 50%, rgba(255,255,255,0.04), transparent 50%)`,
          }}
        />
        {/* Vignette */}
        ...
        <div className="absolute inset-0 pointer-events-none">
          {stars.map((star) => (
            <div
              key={star.id}
              className="absolute bg-white star-breathe"
              style={{
                left: star.left,
                top: star.top,
                width: star.size,
          ...
          <div className="flex items-center gap-3 md:gap-6 lg:gap-8">
            ...
            <div className="desktop-stats-section">
              <div className="flex items-center gap-1.5 lg:gap-2">
                ...
                />
                <div>
                  <div className="text-base md:text-lg lg:text-xl font-black text-white leading-none">
                    {streakCount}
                  </div>
                  <div className="text-[7px] md:text-[8px] text-white/40 font-bold uppercase tracking-wider">
                    Day Streak
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-1.5 lg:gap-2">
                <History
                  className="w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 text-cyan-400"
                  style={{
      ...
      <div className="relative z-20 px-3 sm:px-5 md:px-7 pt-4 sm:pt-6 md:pt-8 lg:pt-10">
        ...
        <div className="medals-grid-desktop mt-8 md:mt-12 lg:mt-16">
          ...
          <div className="flex flex-col items-center p-1.5 md:p-2">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-yellow-200 to-yellow-400">
              {medals.gold}
            </div>
            <div className="text-xs md:text-sm font-bold text-yellow-200">
              Gold Star
            </div>
          ...
          <div className="flex flex-col items-center p-1.5 md:p-2">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-gray-100 to-gray-300">
              {medals.silver}
            </div>
            <div className="text-xs md:text-sm font-bold text-gray-200">
              Silver Star
            </div>
          ...
          <div className="flex flex-col items-center p-1.5 md:p-2">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-[#E3AF66] to-[#CD7F32]">
              {medals.bronze}
            </div>
            <div className="text-xs md:text-sm font-bold text-[#E3AF66]">
              Bronze Star
            </div>
          ...
          <div className="flex flex-col items-center p-1.5 md:p-2">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-red-200 to-red-400">
              {medals.review}
            </div>
            <div className="text-xs md:text-sm font-bold text-red-200">
              Need Review
            </div>
            <div className="text-[10px] md:text-xs text-white/50">
              Below 50%
        ...
        <div className="medals-grid-mobile">
          <div className="grid grid-cols-3 mt-3 gap-3 w-full max-w-sm mx-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-br from-yellow-200 to-yellow-400">
                {medals.gold}
              </div>
              <div className="text-[11px] font-bold text-yellow-200">
                Gold Star
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-br from-gray-100 to-gray-300">
                {medals.silver}
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-br from-[#E3AF66] to-[#CD7F32]">
                {medals.bronze}
              </div>
              <div className="text-[11px] font-bold text-[#E3AF66]">
                Bronze Star
              </div>
      ...
      <div className="relative z-20 mt-15 sm:mt-14 md:mt-20 lg:mt-24">
        ...
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] -translate-y-[99%]">
          <svg
            ...
            className="block w-full h-[50px] sm:h-[60px] md:h-[70px] lg:h-[80px]"
          >
            <path
              d="M0,40 C150,30 300,20 450,25 C600,30 750,45 900,40 C1050,35 1150,30 1200,28 L1200,80 L0,80 Z"
              fill="white"
            />
          </svg>
        </div>
        ...
        <div className="bg-white flex flex-col items-center justify-center pt-8 sm:pt-10 pb-16 sm:pb-20">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-[#1a1f36] tracking-tight text-center px-4">
            Begin a New Learning Sheet
          </h2>
          <p className="mt-1.5 sm:mt-2 text-[9px] sm:text-[10px] md:text-xs font-bold text-[#1a1f36]/50 uppercase tracking-[0.2em] sm:tracking-[0.25em] text-center">
            One focused session. Zero distractions.
          </p>
      ...
      <UpgradeModal
        ...
        monthlyUrl={monthlyUrlTest}
        yearlyUrl={yearlyUrlTest}
      />
