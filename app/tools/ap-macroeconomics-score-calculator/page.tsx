...
import {
  ...
  ArrowRight, RotateCcw, Info, TrendingDown,
} from "lucide-react";

// ─── AP Macroeconomics 2026 Scoring ───────────────────────────────────────
...
// AP Macro has a moderate 5 rate (~20–24%) and passing rate (~55–60%)
...
const FRQ_CONFIG = [
  {
    ...
    max: 10,
    desc: "A multi-part question requiring labeled graph construction and analysis — typically involves AD/AS, money market, loanable funds, or foreign exchange market; graph labels and axis labels are required for full credit",
  },
  {
    label: "FRQ 2 — Short Free Response",
    max: 5,
    desc: "A focused question on a specific macroeconomic concept — policy effects, market outcomes, or theoretical explanations; typically 3–5 parts worth 1 point each",
  },
  {
    label: "FRQ 3 — Short Free Response",
    max: 5,
    desc: "A second focused question testing a different concept — common topics include fiscal/monetary policy, balance of payments, exchange rates, or economic indicators",
  },
];
...
function getScoreMessage(score: number): string {
  return ({
    5: "Outstanding — you've mastered macroeconomic models, policy analysis, and graph construction across every major unit.",
    4: "Strong result. A 4 on AP Macroeconomics shows solid command of economic models and their real-world policy implications.",
    3: "You're in qualifying territory. Sharpen your graph labeling on the long FRQ and policy transmission chains to push higher.",
    2: "You're building the foundation. Focus on AD/AS and fiscal policy mechanics — the highest-yield concepts on both sections.",
    1: "Don't be discouraged. Consistent daily practice on AP Macro models and graph construction will turn this around.",
...
const DB_NAME = "lunora_ap_macro"; const DB_VERSION = 1; const STORE = "attempts";
...
export default function APMacroeconomicsScoreCalculator() {
  ...
  const faqs = [
    {
      q: "How is the AP Macroeconomics exam scored in 2026?",
      a: "The AP Macroeconomics exam has two sections. Section 1 is 60 multiple choice questions completed in 1 hour 10 minutes, worth approximately 66.7% of your composite score. Section 2 is 3 free response questions completed in 1 hour, worth approximately 33.3%. FRQ 1 is a long question worth 10 points; FRQs 2 and 3 are short questions worth 5 points each, for a total raw FRQ score of 20. Your raw scores convert to a composite out of 100, which maps to an AP score of 1–5. As with AP Psychology, MCQ carries twice the weight of FRQ.",
    },
    {
      q: "What composite score do I need for a 5 on AP Macroeconomics?",
      a: "Based on recent College Board score distributions, you generally need a composite score of approximately 72 or above to earn a 5 on AP Macroeconomics. About 20–24% of test takers score a 5 each year. The long FRQ — which requires drawing and labeling multiple economic graphs — is the biggest differentiator between a 4 and a 5, since students who lose points on graph labels and axes consistently miss the top score.",
    },
    {
      q: "What composite score do I need for a 3 on AP Macroeconomics?",
      a: "A composite score of approximately 45 or above typically earns a 3 on AP Macroeconomics. About 55–60% of test takers earn a 3 or higher. Students who understand the AD/AS model and basic fiscal and monetary policy mechanics usually reach a 3 even without mastering balance of payments and exchange rates.",
    },
    {
      q: "What is the long FRQ on AP Macroeconomics?",
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", color: "#1a1a1a", fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", "name": "AP Macroeconomics Score Calculator", "description": "Free AP Macroeconomics score calculator for 2026. Enter your multiple choice and free response scores to instantly calculate your composite score and predicted AP score of 1–5.", "url": "https://lunora.app/tools/ap-macroeconomics-score-calculator", "applicationCategory": "EducationApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }, "author": { "@type": "Organization", "name": "Lunora", "url": "https://lunora.app" } }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "How is the AP Macroeconomics exam scored?", "acceptedAnswer": { "@type": "Answer", "text": "AP Macro has two sections. Section 1 is 60 MCQ worth ~66.7% (1h 10min). Section 2 is 3 FRQs worth ~33.3% (1h): FRQ 1 is 10 pts, FRQs 2 and 3 are 5 pts each (20 raw total). Scores convert to a composite out of 100, then to an AP score of 1–5." } }, { "@type": "Question", "name": "What composite score do I need for a 5 on AP Macroeconomics?", "acceptedAnswer": { "@type": "Answer", "text": "You generally need a composite score of approximately 72 or above for a 5 on AP Macroeconomics. About 20–24% of students score a 5 each year." } }, { "@type": "Question", "name": "What is the long FRQ on AP Macroeconomics?", "acceptedAnswer": { "@type": "Answer", "text": "FRQ 1 is worth 10 points and requires drawing and labeling multiple economic graphs — typically AD/AS, money market, loanable funds, and/or foreign exchange. Unlabeled axes or curves earn zero for those graph parts." } }, { "@type": "Question", "name": "What graphs do I need to know for AP Macroeconomics?", "acceptedAnswer": { "@type": "Answer", "text": "The six core graphs: AD/AS, money market, loanable funds market, foreign exchange market, production possibilities curve, and Phillips curve. Every graph requires labeled axes, labeled curves, and shown shifts for full credit." } }, { "@type": "Question", "name": "What is the difference between AP Macroeconomics and AP Microeconomics?", "acceptedAnswer": { "@type": "Answer", "text": "AP Macro covers the whole economy (GDP, inflation, fiscal/monetary policy, international trade). AP Micro covers individual markets and firms (supply/demand, market structures, factor markets). Both use the same exam format." } } ] }) }} />
            ...
            <div className="score-card">
              ...
              <div style={{ marginTop: 16, marginBottom: 24, padding: "12px 14px", background: "rgba(74,124,199,0.06)", borderRadius: 10, border: "1px solid rgba(74,124,199,0.15)" }}>
                <p style={{ fontSize: 12, color: "#4a7cc7", lineHeight: 1.6, margin: 0 }}>
                  <strong>Label every axis, curve, and shift.</strong> The long FRQ awards points per graph element — an unlabeled axis or curve earns zero for that part even if the shift direction is correct. Practice drawing AD/AS, money market, loanable funds, and forex graphs until labeling is automatic.
                </p>
              </div>
      ...
      <section style={{ padding: "80px 24px", background: "#fafbfd" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <h2 style={{ fontSize: 36, fontWeight: 800, color: "#1a1a1a", letterSpacing: "-0.025em", marginBottom: 12 }}>How the AP Macroeconomics score is calculated</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
            {[
              { Icon: BarChart2, color: "#203567", title: "Section 1: MCQ", sub: "~66.7% of total score", body: "60 questions in 1 hour 10 minutes covering all six units. Questions test understanding of economic models, policy effects, and quantitative relationships like multipliers. Units 3 (AD/AS) and 4 (financial sector) are the highest-yield units.", formula: "MCQ / 60 × 66.7" },
              { Icon: TrendingDown, color: "#4a7cc7", title: "FRQ 1 — Long", sub: "10 pts · graph-heavy", body: "Worth 50% of the FRQ section. Typically 8–12 parts requiring drawn and labeled graphs across multiple markets. Points are awarded per element: axis label, curve label, shift arrow. An unlabeled axis earns zero for that graph part regardless of correctness.", formula: "draw · label · shift" },
              { Icon: TrendingUp, color: "#2d6e9e", title: "FRQs 2 & 3 — Short", sub: "5 pts each · focused", body: "Two targeted questions on specific concepts. Common topics: fiscal multiplier effects, monetary policy transmission, balance of payments accounting, currency appreciation/depreciation effects on net exports, and supply-side policies.", formula: "FRQ2 + FRQ3 / 10 × 16.7" },
              { Icon: Trophy, color: "#1a7a4a", title: "AP Score", sub: "1–5", body: "Composite ≥72 → 5 · ≥58 → 4 · ≥45 → 3 · ≥33 → 2 · below → 1. About 20–24% of students earn a 5. Passing rate is ~55–60%. Graph labeling mastery on the long FRQ consistently separates 4s from 5s.", formula: "composite → 1–5" },
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }} className="promo-grid">
          <div>
            ...
            <Link href="/signin" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "white", color: "#203567", fontWeight: 800, fontSize: 15, padding: "14px 32px", borderRadius: 100, textDecoration: "none" }}>
              Try Lunora for AP Macroeconomics — Free <ArrowRight size={15} color="#203567" strokeWidth={2.5} />
            </Link>
            <div style={{ marginTop: 14, fontSize: 12, color: "rgba(255,255,255,0.35)" }}>No credit card needed</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { Icon: Sparkles, title: "Unlimited AP Macro practice questions", body: "Generate MCQ and FRQ-style questions on every unit — AD/AS, monetary policy, loanable funds, balance of payments — directly from your own notes and textbook chapters." },
              { Icon: Brain, title: "Drill full policy transmission chains", body: "Practice tracing every step: fiscal stimulus → AD shifts right → price level rises → money demand increases → interest rates rise → crowding out. Build the chain fluency the FRQ demands." },
              { Icon: TrendingUp, title: "Track mastery across all 6 units", body: "See your accuracy across all six AP Macro units. Know exactly which areas — financial sector, open economy — still need work before exam day." },
              { Icon: Clock, title: "Short daily sessions that work", body: "AP Macro rewards model fluency built over time. Focused daily sessions connecting concepts across units — rather than cramming — build the understanding the MCQ tests." },
      ...
      <section id="faq" style={{ padding: "80px 24px", background: "#fafbfd" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <h2 style={{ fontSize: 36, fontWeight: 800, color: "#203567", letterSpacing: "-0.025em" }}>AP Macroeconomics Score Calculator FAQ</h2>
            <p style={{ fontSize: 15, color: "#8899bb", marginTop: 10 }}>Everything you need to know about how AP Macroeconomics is scored.</p>
          </div>
      ...
      <section style={{ padding: "80px 24px", background: "#203567" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.65)", marginBottom: 36, lineHeight: 1.65 }}>Turn your AP Macroeconomics notes into unlimited unit-by-unit practice questions and graph drills. Track your progress to a 5.</p>
