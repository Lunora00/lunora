...
import {
  ...
  ArrowRight, RotateCcw, Info, PenTool,
} from "lucide-react";

// ─── AP English Language & Composition 2026 Scoring ───────────────────────
// Section 1: 45 MCQ → 45% of composite · 1h
// Section 2: 3 FRQ (essays) → 55% of composite · 2h 15min
//   Essay 1: Synthesis        /6  (reads 6–7 sources, builds argument)
//   Essay 2: Rhetorical Analysis /6  (analyzes a provided passage)
//   Essay 3: Argument         /6  (builds own argument, no provided text)
//   Total FRQ raw = 18 pts
// Composite = (MCQ/45 × 45) + (FRQ_raw/18 × 55) → /100
// AP Score thresholds (approximate, College Board 2024–2025 data)
// AP English Language is the most-taken AP exam (~540k+ students)
// 5 rate ~10–12%, passing rate ~55–62%
...
const FRQ_CONFIG = [
  {
    label: "Essay 1 — Synthesis",
    max: 6,
    desc: "Read 6–7 provided sources on a given topic, then write an evidence-based argument that synthesizes at least 3 of the sources. Scored on thesis (0–1), evidence/commentary (0–4), and sophistication (0–1).",
  },
  {
    label: "Essay 2 — Rhetorical Analysis",
    max: 6,
    desc: "Read a provided passage (speech, essay, or letter) and analyze how the writer's rhetorical choices build their argument or achieve their purpose. Scored on thesis (0–1), evidence/commentary (0–4), and sophistication (0–1).",
  },
  {
    label: "Essay 3 — Argument",
    max: 6,
    desc: "Write an argument defending, challenging, or qualifying a provided claim using your own evidence, reasoning, and examples from reading, observation, or experience. Scored on thesis (0–1), evidence/commentary (0–4), and sophistication (0–1).",
  },
];
...
function getScoreMessage(score: number): string {
  return ({
    5: "Outstanding — you've mastered argumentation, rhetorical analysis, and source synthesis at the highest level.",
    4: "Strong result. A 4 on AP English Language demonstrates genuine command of rhetoric and evidence-based writing.",
    3: "You're in qualifying territory. Sharpen your thesis precision and commentary depth to push into a 4.",
    2: "You're building the foundation. Focus on writing clear, defensible theses and developing evidence with commentary.",
    1: "Don't be discouraged. Consistent essay practice with feedback on thesis and evidence will turn this around.",
...
const DB_NAME = "lunora_ap_lang"; const DB_VERSION = 1; const STORE = "attempts";
...
export default function APEnglishLanguageScoreCalculator() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", color: "#1a1a1a", fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", "name": "AP English Language Score Calculator", "description": "Free AP English Language score calculator for 2026. Enter your MCQ and essay scores to instantly calculate your composite score and predicted AP score of 1–5.", "url": "https://lunora.app/tools/ap-english-language-score-calculator", "applicationCategory": "EducationApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }, "author": { "@type": "Organization", "name": "Lunora", "url": "https://lunora.app" } }) }} />
            ...
            <div className="score-card" style={{ marginBottom: 24 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 12, color: "#aaa", marginTop: 2 }}>45 questions · <strong style={{ color: "#203567" }}>45%</strong> of total score · 1h</p>
                </div>
              </div>
            ...
            <div className="score-card">
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 12, color: "#aaa", marginTop: 2 }}>3 essays · 6 pts each · <strong style={{ color: "#203567" }}>55%</strong> of total score · 2h 15min</p>
                </div>
              </div>
              <div style={{ marginTop: 16, marginBottom: 24, padding: "12px 14px", background: "rgba(74,124,199,0.06)", borderRadius: 10, border: "1px solid rgba(74,124,199,0.15)" }}>
                <p style={{ fontSize: 12, color: "#4a7cc7", lineHeight: 1.6, margin: 0 }}>
                  <strong>Each essay: Thesis (1 pt) + Evidence & Commentary (0–4 pts) + Sophistication (1 pt).</strong> The evidence and commentary row is worth the most — always follow evidence with an explanation of how it supports your thesis.
                </p>
              </div>
          ...
          <div>
            <div style={{ borderRadius: 24, background: scoreBg, border: `2px solid ${scoreColor}22`, padding: "32px 28px", marginBottom: 20, textAlign: "center", position: "sticky", top: 140 }}>
              ...
              <div style={{ textAlign: "left" }}>
                ...
                <BreakdownBar label="Synthesis" score={frq[0]} max={FRQ_CONFIG[0].max} color="#4a7cc7" />
                <BreakdownBar label="Rhet. Analysis" score={frq[1]} max={FRQ_CONFIG[1].max} color="#4a7cc7" />
                <BreakdownBar label="Argument" score={frq[2]} max={FRQ_CONFIG[2].max} color="#4a7cc7" />
      ...
      <section style={{ padding: "80px 24px", background: "#fafbfd" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <h2 style={{ fontSize: 36, fontWeight: 800, color: "#1a1a1a", letterSpacing: "-0.025em", marginBottom: 12 }}>How the AP English Language score is calculated</h2>
            <p style={{ fontSize: 16, color: "#777", maxWidth: 540, margin: "0 auto" }}>Essays carry 55% of the composite — more than MCQ — making writing quality the primary driver of your AP score.</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
            {[
              { Icon: BarChart2, color: "#203567", title: "Section 1: MCQ", sub: "45% of total score", body: "45 questions in 1 hour across two question sets — reading for rhetorical analysis and reading for argumentation. Questions test understanding of author's purpose, rhetorical strategies, evidence use, and stylistic choices in nonfiction prose passages.", formula: "MCQ / 45 × 45" },
              { Icon: PenTool, color: "#4a7cc7", title: "Essay Rubric", sub: "6 pts per essay", body: "Each essay scored: Thesis (0–1 pt) — defensible claim with line of reasoning. Evidence & Commentary (0–4 pts) — specific evidence with explanation of how it supports the thesis. Sophistication (0–1 pt) — complex argument, compelling prose, or broader context.", formula: "thesis + evidence + soph." },
              { Icon: TrendingUp, color: "#2d6e9e", title: "Essays Carry More", sub: "55% of total score", body: "Three essays (synthesis, rhetorical analysis, argument) in 2 hours 15 minutes. Unlike most AP exams where MCQ and FRQ share equal weight, AP Lang weights FRQ higher — making essay preparation the most important investment.", formula: "FRQ_raw / 18 × 55" },
              { Icon: Trophy, color: "#1a7a4a", title: "AP Score", sub: "1–5", body: "Composite ≥72 → 5 · ≥58 → 4 · ≥44 → 3 · ≥30 → 2 · below → 1. About 10–12% of 540k+ students earn a 5. With the largest AP test population, strong writing that consistently earns the sophistication point separates top scores.", formula: "composite → 1–5" },
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }} className="promo-grid">
          <div>
            ...
            <Link href="/signin" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "white", color: "#203567", fontWeight: 800, fontSize: 15, padding: "14px 32px", borderRadius: 100, textDecoration: "none" }}>
              Try Lunora for AP English Language — Free <ArrowRight size={15} color="#203567" strokeWidth={2.5} />
            </Link>
            <div style={{ marginTop: 14, fontSize: 12, color: "rgba(255,255,255,0.35)" }}>No credit card needed</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { Icon: Sparkles, title: "Unlimited AP Lang practice prompts", body: "Generate synthesis, rhetorical analysis, and argument prompts from your own readings and course materials. Practice every essay type until the structure is second nature." },
              { Icon: Brain, title: "Master evidence and commentary", body: "The evidence & commentary row is worth 4 of 6 essay points. Practice explaining how every piece of evidence supports your specific thesis — not just what the evidence says." },
              { Icon: TrendingUp, title: "Track essay score trends", body: "Log scores for each essay type across practice sessions. Know which essay — synthesis, rhetorical analysis, or argument — is your strongest and which needs the most work." },
              { Icon: Clock, title: "Short daily sessions that work", body: "AP Lang rewards writing habits built over time. Focused daily sessions on thesis construction, commentary depth, and rhetorical vocabulary compound into exam-day fluency." },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
            {otherExams.map(({ name, href }) => (
              <Link key={name} href={href} className="exam-card">
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={{ width: 28, height: 28, borderRadius: 7, background: "rgba(32,53,103,0.07)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><PenTool size={13} color="#203567" strokeWidth={2} /></div>
                  <div>
      ...
      <section id="faq" style={{ padding: "80px 24px", background: "#fafbfd" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <h2 style={{ fontSize: 36, fontWeight: 800, color: "#203567", letterSpacing: "-0.025em" }}>AP English Language Score Calculator FAQ</h2>
            <p style={{ fontSize: 15, color: "#8899bb", marginTop: 10 }}>Everything you need to know about how AP English Language and Composition is scored.</p>
          </div>
      ...
      <section style={{ padding: "80px 24px", background: "#203567" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.65)", marginBottom: 36, lineHeight: 1.65 }}>Turn your AP English Language readings and notes into unlimited essay practice and MCQ drills. Track your progress to a 5.</p>
